...
--
-- Host: localhost
-- Generation Time: Apr 03, 2019 at 07:19 PM
...
(1, 'Ruf ruf ruf ruf ruf.', 'Ruf Ruf 19', 22.5, 14, '9 AM', '8 PM', NULL, NULL, 1);
...
(1, 'Cookies', 'Ruf ruf, ruf ruf!', NULL, NULL),
(2, 'Chocolates', 'Ruf ruf ruf ruf ruf ruf!', NULL, NULL),
(3, 'Waffles', 'Ruf ruf ruf.', NULL, NULL);
...
(1, 'ruf_123', 'ruf@gmail.com', 'ruf?', '2019-04-04 00:00:00', '2019-04-08 00:00:00', 'Ruf', 'Rufalskiz', NULL);
...
(1, 'Ruf ruf ruf ruf ruf ruf, ruf ruf ruf!', 1, 1);
...
(1, 'Blue SK\'s', 0, NULL, 1, 3, 1.95, NULL),
...
--
ALTER TABLE `bakery`
  MODIFY `bakery_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `responsibility_category`
  MODIFY `responsibility_category_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `user_admin`
  MODIFY `admin_number` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `waffle`
  MODIFY `waffle_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
